      ...
      >
        ...
        >
          <Box as={Flex} flexDirection="column">
            ...
            <Text as={Link} to="/">Mens Collection</Text>
            <Text as={Link} to="/">Womens Collection</Text>
            <Text as={Link} to="/" >Shoes Collection</Text>
            <Text as={Link} to="/">Clothes Collection</Text>
          </Box>
